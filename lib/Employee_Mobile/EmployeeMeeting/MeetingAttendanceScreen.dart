...
class MeetingAttendanceScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String? virtualLink = meeting['virtual_link']?.toString();
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: isCancelled 
                        ...
                        : (isDone ? Colors.grey.withOpacity(0.2) : forestGreen.withOpacity(0.1)), 
                    borderRadius: BorderRadius.circular(20)
                  ), 
                  child: Text(
                    isCancelled 
                        ? "Cancelled" 
                        : (isDone ? "Meeting Completed" : "Attending"), 
                    style: TextStyle(
                      color: isCancelled ? errorRed : (isDone ? Colors.grey[700] : forestGreen), 
                      fontSize: 12,
