...
class _ReportScreenState extends State<ReportScreen> {
  ...
  void _onItemTapped(int index) {
    ...
    if (index == 0) {
      // FIX: Changed HomeScreen to UserDashboard
                ...
                SliverAppBar(
                  ...
                  leading: const Padding(
                    ...
                    child: CircleAvatar(
                      ...
                      backgroundImage: AssetImage('assets/logo1.png'), // Standardized logo
                    ),
                  ),
                  title: const Text(
                    "GreenAtlas", 
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildReportOption(Icons.warning_amber_rounded, "Illegal Logging", "Report unauthorized cutting of trees"),
                        _buildReportOption(Icons.opacity, "Water Pollution", "Report waste disposal in local waterways"),
                        _buildReportOption(Icons.local_fire_department, "Wildfire Risk", "Report smoke or high-risk dry areas"),
                      ],
                    ),
                  ),
                ),
  ...
  Widget _buildReportOption(IconData icon, String title, String subtitle) {
    return Card(
      ...
      child: ListTile(
        ...
        leading: CircleAvatar(backgroundColor: const Color(0xFFF0F4F0), child: Icon(icon, color: Colors.redAccent)),
        title: Text(title, style: const TextStyle(fontWeight: FontWeight.bold)),
        subtitle: Text(subtitle, style: const TextStyle(fontSize: 12)),
        trailing: const Icon(Icons.chevron_right, color: Colors.black26),
        onTap: () {}, // Add logic for detailed report form here
      ),
    );
  }
}